...
def home(qs, favorites_only=False):
    ...
    cards=''.join(job_card(r, r['id'] in favorite_ids, current_path, favorites_only) for r in rows)
    if favorites_only:
